...
public class ReLogoTurtle extends BaseTurtle{
	...
	public AgentSet<firesimulation.relogo.UserTurtle> hatchUserTurtles(int number, Closure closure) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("firesimulation.relogo.UserTurtle")
	public AgentSet<firesimulation.relogo.UserTurtle> hatchUserTurtles(int number) {
	...
	public firesimulation.relogo.UserLink createUserLinkFrom(Turtle t, Closure closure){
		firesimulation.relogo.UserLink link = (firesimulation.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").addEdge(t,this);
		if (closure != null){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("firesimulation.relogo.UserLink")
	public firesimulation.relogo.UserLink createUserLinkFrom(Turtle t){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("firesimulation.relogo.UserLink")
	public AgentSet<firesimulation.relogo.UserLink> createUserLinksFrom(Collection<? extends Turtle> a, Closure closure){
		AgentSet<firesimulation.relogo.UserLink> links = new AgentSet<firesimulation.relogo.UserLink>();
		for(Turtle t : a){
			links.add((firesimulation.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").addEdge(t,this));
		}
		if (closure != null){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("firesimulation.relogo.UserLink")
	public AgentSet<firesimulation.relogo.UserLink> createUserLinksFrom(Collection<? extends Turtle> a){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("firesimulation.relogo.UserLink")
	public firesimulation.relogo.UserLink createUserLinkTo(Turtle t, Closure closure){
		firesimulation.relogo.UserLink link = (firesimulation.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").addEdge(this,t);
		if (closure != null){
			this.ask(link,closure);
		}
		return link;
	 ...
	 */
	@ReLogoBuilderGeneratedFor("firesimulation.relogo.UserLink")
	public firesimulation.relogo.UserLink createUserLinkTo(Turtle t){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("firesimulation.relogo.UserLink")
	public AgentSet<firesimulation.relogo.UserLink> createUserLinksTo(Collection<? extends Turtle> a, Closure closure){
		AgentSet<firesimulation.relogo.UserLink> links = new AgentSet<firesimulation.relogo.UserLink>();
		for(Object t : a){
			if (t instanceof Turtle){
				links.add((firesimulation.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").addEdge(this,(Turtle)t));
			}
		}
		if (closure != null){
			this.ask(links,closure);
	 ...
	 */
	@ReLogoBuilderGeneratedFor("firesimulation.relogo.UserLink")
	public AgentSet<firesimulation.relogo.UserLink> createUserLinksTo(Collection<? extends Turtle> a){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("firesimulation.relogo.UserLink")
	public firesimulation.relogo.UserLink inUserLinkFrom(Turtle t){
		return (firesimulation.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").getEdge(t,this);
	}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("firesimulation.relogo.UserLink")
	public AgentSet<firesimulation.relogo.UserLink> myInUserLinks(){
		AgentSet<firesimulation.relogo.UserLink> result = new AgentSet<firesimulation.relogo.UserLink>();
		for(Object o :  this.getMyObserver().getNetwork("UserLink").getInEdges(this)){
			if (o instanceof firesimulation.relogo.UserLink){
				result.add((firesimulation.relogo.UserLink) o);
			}
		}
		return result;
	}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("firesimulation.relogo.UserLink")
	public AgentSet<firesimulation.relogo.UserLink> myOutUserLinks(){
		AgentSet<firesimulation.relogo.UserLink> result = new AgentSet<firesimulation.relogo.UserLink>();
	 ...
	 */
	@ReLogoBuilderGeneratedFor("firesimulation.relogo.UserLink")
	public firesimulation.relogo.UserLink outUserLinkTo(Turtle t){
		return (firesimulation.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").getEdge(this, t);
	}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("firesimulation.relogo.UserLink")
	public AgentSet<firesimulation.relogo.UserLink> myUserLinks(){
		AgentSet<firesimulation.relogo.UserLink> result = new AgentSet<firesimulation.relogo.UserLink>();
